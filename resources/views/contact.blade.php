                ...
                <div class="col-md-8">
                    <div class="top-bar-left">
                        ...
                        <div class="text">
                            ...
                            <h2> <img src="img/uk.png" alt="Icon" style="width: 20px; height:20px">+44-113-328-0567 ,
                            </h2>
                            <h2> <img src="img/canada.png" alt="Icon" style="width: 20px; height:20px">+1703-537-5081
                            </h2>
                            <p>For Appointment</p>
                        </div>
                    </div>
