            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-6">
                        <div class="fact-item">
                            <img src="img/icons8-team-64.png" alt="Icon">
                            <h2>Qualified Team</h2>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="fact-item">
                            {{-- <img src="img/icons8-edit-file-50.png" alt="Icon"> --}}
                            <i class="bi bi-pencil-square" style="font-size: 3rem ;color:#008080"></i>
                            <h2>Individual Approach</h2>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="fact-item">
                            <img src="img/icons8-progress-100.png" alt="Icon">
                            <h2>100% Success</h2>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="fact-item">
                            <img src="img/icons8-customer-64.png" alt="Icon">
                    ...
                    <div class="col-md-6">
                        <div class="about-img">
                            <div class="about-img-1">
                                <img src="img/pexels-kateryna-babaieva-2760243.jpg" alt="Image">
                            </div>
                            <div class="about-img-2">
                                <img src="img/pexels-fauxels-3184306.jpg" alt="Image">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="about-text">
                            <p>
                                Have you ever gone through piles of resumes, called people for interviews and spent time, money and effort on candidates that just didn’t fit the portfolio that 
                                you needed? The answer is a Search Firm that exclusively specializes in the Structural Design industry, and that can identify talented candidates that fit 
                                your firm’s requirements and specifications.
                            </p>
                            <p>
                                We attract and identify a range of talented industry professionals that match a variety of job descriptions within the Structural Design industry.
                            </p>
                            <p>
                                We’ve built our business on adding value for our clients far beyond the traditional, transactional hiring process. We accomplish this by providing market feedback and networking activities.

                            </p>

                            <p>We combine vigorous analysis, interviewing and candidate profiling with a partnership-based approach aimed at understanding a business’s needs and culture, and the position to be filled. </p>

                            <P>We have a proven track record of fulfilling roles from Designer to mid- and senior management positions, using our exclusive industry research capabilities and years of experience</P>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <p>
                                We’ve built our business on adding value for our clients far beyond the traditional, transactional hiring process.
                            </p>
                            {{-- <a href="">Read More</a> --}}
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            <img src="img/icons8-permanent-job-80.png" alt="Icon">
                            <h3>Positions</h3>
                            <p>
                              We have a wide range of positions available on a casual or permanent basis .
                            </p>
                            {{-- <a href="">Read More</a> --}}
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <p>
                                We specialize in the Structural Design industry, and we can identify talented candidates that fit your firm’s requirements.
                            </p>
                            {{-- <a href="">Read More</a> --}}
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <h3>Advisers</h3>
                            <p>
                                We have advisers who listen to you and understand the role you are seeking
                ...
                <div class="row align-items-end">
                    <div class="col-md-6">
                        <div class="feature-img">
                            <img src="img/pexels-kindel-media-8487782_1_-removebg-preview.png" alt="Image">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="section-header">
                        ...
                        <p>
                            We combine vigorous analysis, interviewing and candidate profiling with a partnership-based approach aimed at understanding a business’s needs and culture, 
                            and the position to be filled. . We have a proven track record of fulfilling roles from Designer to mid- and senior management positions, using our exclusive industry 
                            research capabilities and years of experience.
                        </p>
